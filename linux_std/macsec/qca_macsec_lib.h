...
#ifndef _QCA_MACSEC_LIB_H_
#define _QCA_MACSEC_LIB_H_
...
/* Replay window for replay protection (32-bit register) */
...
/* MACsec software control register */
...
#define LPI_RCOVER_EN				BIT(15)
#define E_FORWARD_PATTERN_EN			BIT(13)
#define I_FORWARD_PATTERN_EN			BIT(12)
